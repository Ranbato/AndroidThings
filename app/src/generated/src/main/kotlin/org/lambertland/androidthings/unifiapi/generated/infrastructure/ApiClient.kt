package org.lambertland.androidthings.unifiapi.generated.infrastructure
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "org.lambertland.androidthings.unifiapi.generated.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val tempFile = java.nio.file.Files.createTempFile("tmp.org.lambertland.androidthings.unifiapi.generated", null).toFile()
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
            if (apiKey["csrf_token"] != null) {
                if (apiKeyPrefix["csrf_token"] != null) {
                } else {
                }
            }
        }
            if (apiKey["unifises"] != null) {
                if (apiKeyPrefix["unifises"] != null) {
                } else {
                }
            }
        }
